...
float MultiResolutionMatcher::Score(common::PointCloudType::Ptr raw_points, float z_ground, SE3& init_pose,
...
ScoreBoard::BestOffsetPtr MultiResolutionMatcher::ScoreOneLayer(common::PointCloudType::Ptr points, float z_ground,
    ...
    ScoreBoard board;
    common::PointCloudType::Ptr points0(new common::PointCloudType());
...
common::PointCloudType::Ptr MultiResolutionMatcher::TrimRawPoints(common::PointCloudType::Ptr raw_points,
                                                                  float resolution) {
